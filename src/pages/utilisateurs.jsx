  ...
  const fetchAdmins = useCallback(async (opts = {}) => {
    ...
    try {
      const params = {
        ...
        role: "admin", // côté API ou fallback
        page: currentPage,
        pageSize: PAGE_SIZE,
      };
      ...
      if (r1.status >= 200 && r1.status < 300) {
        ...
        // ✅ on conserve l’_id d’origine et on ajoute _idString si absent
        list = items.map((u) => ({
          ...u,
            ...
            <>
              <div className="overflow-x-auto">
                <table className="min-w-full border border-gray-200">
                  ...
                  <tbody>
                    {users.map((u) => {
                      const id = idForApi(u) || u.email; // clé stable
                      ...
                      const isRowBusy = rowBusyId === idForApi(u);
